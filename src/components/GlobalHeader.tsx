    ...
    return <header className="px-2 sm:px-8 flex justify-between items-center border-b border-gray-200 bg-white">
        ...
        {!isPropertiesPage &&
            <nav className="hidden md:flex items-center space-x-6 text-base font-medium">        
                <Link className="hover:text-primary" href={{ pathname: "/properties", query: { tab: "For Sale" } }} >Buy</Link>
                <Link className="hover:text-primary" href={{ pathname: "/properties", query: { tab: "For Rent" } }}>Rent</Link>
                <Link className="hover:text-primary" href={{ pathname: "/properties", query: { tab: "Short-let" } }}>Short-let</Link>
                <Link className="hover:text-primary" href={{ pathname: "/properties", query: { tab: "Commercial" } }}>Commercial</Link>
            </nav>}
        <div className="flex gap-4 items-center text-sm md:text-base font-medium pr-2">            
            <Link className="hidden md:flex hover:text-primary" href="/auth/agent-login">
                Login
            </Link>
            <Link
            ...
            <Link href="/contact" className="flex items-center space-x-1 hover:text-primary">
